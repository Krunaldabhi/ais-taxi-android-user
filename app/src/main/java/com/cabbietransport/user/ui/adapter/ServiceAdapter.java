package com.cabbietransport.user.ui.adapter;
...
import static com.cabbietransport.user.base.BaseActivity.getNumberFormat;
import static com.cabbietransport.user.base.BaseActivity.getTwoDecimalNumberFormat;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder,
        ...
        if (estimateFare != null) {
            ...
            holder.estimated_fixed.setText(SharedHelper.getKey(context, "currency") + " " +
                    getNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() - 3))) + "-" + getTwoDecimalNumberFormat().format(Double.parseDouble(String.valueOf(estimateFare.getEstimatedFare() + 5))));
