package com.cabbietransport.user.ui.fragment.service_flow;
...
import com.cabbietransport.user.ui.fragment.cancel_ride.CancelRideDialogFragment;
...
import com.cabbietransport.user.common.CancelRequestInterface;
...
import com.cabbietransport.user.data.network.model.ProviderService;
import com.cabbietransport.user.data.network.model.ServiceType;
    ...
    public void onResume() {
        ...
        runnable = () -> {
            try {
                ...
                if (MvpApplication.DATUM.getStatus().equalsIgnoreCase(STARTED)
                        || MvpApplication.DATUM.getStatus().equalsIgnoreCase(ARRIVED)) {
                    src = new LatLng((Double) MvpApplication.RIDE_REQUEST.get(SRC_LAT), (Double) MvpApplication.RIDE_REQUEST.get(SRC_LONG));
                    des = SharedHelper.getCurrentLocation(getContext());
                } else if (MvpApplication.DATUM.getStatus().equalsIgnoreCase(PICKED_UP)) {
