...
import com.cabbietransport.user.data.network.model.Rating;
import com.cabbietransport.user.ui.fragment.InvoiceDialogFragment;
import com.cabbietransport.user.ui.fragment.dispute.DisputeCallBack;
import com.cabbietransport.user.ui.fragment.dispute.DisputeFragment;
import com.cabbietransport.user.ui.fragment.dispute_status.DisputeStatusFragment;
import com.cabbietransport.user.ui.fragment.lost_item.LostFragment;
import com.cabbietransport.user.ui.fragment.lost_item_status.LostItemStatusFragment;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailsIView, DisputeCallBack {
    ...
    public void initView() {
        ...
        if (MvpApplication.DATUM != null) {
            showLoading();
            presenter.getPastTripDetails(MvpApplication.DATUM.getId());
        }
    }
