...
import com.cabbietransport.user.common.EqualSpacingItemDecoration;
...
import com.cabbietransport.user.ui.activity.payment.PaymentActivity;
import com.cabbietransport.user.ui.adapter.ServiceAdapter;
...
import com.cabbietransport.user.ui.fragment.select_payment.SelectPaymentFragment;
...
import static com.cabbietransport.user.common.Constants.RIDE_REQUEST.DISTANCE_VAL;
import static com.cabbietransport.user.common.Constants.RIDE_REQUEST.PAYMENT_MODE;
import static com.cabbietransport.user.common.Constants.RIDE_REQUEST.SERVICE_TYPE;
import static com.cabbietransport.user.data.SharedHelper.getKey;
import static com.cabbietransport.user.data.SharedHelper.getProviders;
...
public class ServiceTypesFragment extends BaseFragment implements ServiceTypesIView {
    ...
    private ServiceListener mListener = pos -> {
        ...
        MvpApplication.RIDE_REQUEST.put(SERVICE_TYPE, mServices.get(pos).getId());
        showLoading();
        estimatedApiCall();
        ...
        switch (view.getId()) {
            ...
            case R.id.get_pricing:
                if (adapter != null) {
                    ...
                    if (service != null) {
                        MvpApplication.RIDE_REQUEST.put(SERVICE_TYPE, service.getId());
                        if (MvpApplication.RIDE_REQUEST.containsKey(SERVICE_TYPE) && MvpApplication.RIDE_REQUEST.get(SERVICE_TYPE) != null) {
                            showLoading();
                            estimatedApiCall();
                        }
                    }
                    ...
                    if (response.body() != null) {
                        ...
                        if (isFromAdapter) {
                            ...
                            if (service != null) {
                                ...
                                ((MainActivity) Objects.requireNonNull(getActivity())).changeFragment(selectPaymentFragment);
                            }
                        }
    ...
    public void onSuccess(List<Service> services) {
        ...
        if (services != null && !services.isEmpty()) {
            MvpApplication.RIDE_REQUEST.put(SERVICE_TYPE, 1);
            mServices.clear();
            ...
            if (adapter != null) {
                ...
                if (mService != null) MvpApplication.RIDE_REQUEST.put(SERVICE_TYPE, mService.getId());
            }
