package com.cabbietransport.user.base;
...
import com.cabbietransport.user.ui.activity.OnBoardActivity;
import com.cabbietransport.user.ui.activity.login.EmailActivity;
import com.cabbietransport.user.ui.activity.login.PasswordActivity;
import com.cabbietransport.user.ui.activity.register.RegisterActivity;
import com.cabbietransport.user.ui.activity.social.SocialLoginActivity;
import com.cabbietransport.user.ui.activity.splash.SplashActivity;
import com.cabbietransport.user.ui.countrypicker.Country;
...
import com.cabbietransport.user.common.CustomDialog;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    public static NumberFormat getNumberFormat() {
        String currencyCode = SharedHelper.getKey(MvpApplication.getInstance(), "currency_code", "AED");
    ...
    public static NumberFormat getTwoDecimalNumberFormat() {
            ...
            btnSendLocation.setOnClickListener(view -> {
                if (btnSendLocation.getVisibility() == View.VISIBLE) {
                    ...
                    try {
                        ...
                        smsIntent.putExtra("sms_body", "I need a ride @" +
                                SharedHelper.getKey(baseActivity(), "latitude") + "," +
                                SharedHelper.getKey(baseActivity(), "longitude") + "( Please don't edit this SMS. Standard SMS charge may apply )");
