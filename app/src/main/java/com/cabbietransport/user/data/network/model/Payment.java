package com.cabbietransport.user.data.network.model;
...
public class Payment {
    ...
    @SerializedName("uae_surcharge")
    @Expose
    private double mUAESurcharges;
    ...
    public double getmUAESurcharges() {
        return mUAESurcharges;
    }

    public void setmUAESurcharges(double mUAESurcharges) {
        this.mUAESurcharges = mUAESurcharges;
    }
}
