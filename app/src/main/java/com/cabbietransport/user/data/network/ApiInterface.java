package com.cabbietransport.user.data.network;
...
import com.cabbietransport.user.data.network.model.Coupon;
...
import com.cabbietransport.user.data.network.model.Rental;
...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    @POST("api/user/add/money")
    Observable<TelrAddWallet> addMoneyUsingTelr(@FieldMap HashMap<String, Object> params);
    ...
    @POST("api/user/telr/response")
    Observable<TelrResponse> getTelrLastTransactionId();
}
